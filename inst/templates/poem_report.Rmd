...
#make table
kable(work_rqst, format = 'latex', align = c('r','c','c')) %>% 
...
division.requests.table %>%
  ...
  kable(format = 'latex', align = c('r', 'c', 'c', 'c', 'c'))  %>%
  kable_styling(latex_options = c('striped', 'hold_position'))
```
